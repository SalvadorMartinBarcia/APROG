...
/* package factoriales-0.1.0.0 */
#define VERSION_factoriales "0.1.0.0"
#define MIN_VERSION_factoriales(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "factoriales-0.1.0.0-EuJ635aIkR9E8nGAsThFH1"

#define CURRENT_PACKAGE_KEY "factoriales-0.1.0.0-EuJ635aIkR9E8nGAsThFH1"
