...
namespace ApartadoC
{
    ...
    {
        List<Tuple<ApartadoCVentana.Provincia, ColorProvincia>> sol;
        ...
        private void pintarMapa()
        {
            ...
            sol = ApartadoCVentana.SolucionColorear(
                new Tuple<ApartadoCVentana.Mapa, List<ColorProvincia>>(ApartadoCVentana.andalucia,
                                                                        colores1));
        ...
        private void FuncionIntroducirProvincias(List<Tuple<ApartadoCVentana.Provincia, ColorProvincia>> sol)
        {
            foreach (Tuple<ApartadoCVentana.Provincia, ColorProvincia> t in sol)
            {
